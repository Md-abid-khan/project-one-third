...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        loginUser(email, password)
            ...
            .catch(error => {
                console.log(error);
                toast.error('Your Id is not valid, Please register')
                navigate("/register")
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl mx-auto mt-30">
                ...
                <div className="card-body">
                    <form onSubmit={handleLogin} className="fieldset">
                        ...
                        <div><a onClick={forgetPass} className="link link-hover">Forgot password?</a></div>
                        <button type='submit' className="btn btn-neutral mt-4" >Login</button>
                    </form>
                    <p>Already have an Account? Click <Link to={"/register"} className='text-red-600'>Register</Link></p>
                    <button onClick={gooogleLoginButton} className="btn bg-white text-black border-[#e5e5e5]">
