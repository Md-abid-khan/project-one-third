...
const Login = () => {
    const { loginUser ,googleLogin ,forgetPassword} = use(AuthContext);
    const location = useLocation();
    // console.log(location);
    const navigate = useNavigate();
    const notify = () => toast('Your Id is not valid, Please register');
        ...
        <div>
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl mx-auto mt-30">
                ...
                <div className="card-body">
                    ...
                    <button onClick={gooogleLogin} className="btn bg-white text-black border-[#e5e5e5]">
